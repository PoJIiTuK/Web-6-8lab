...
public class UserProfileDAO implements GeneralDAO<UserProfile> {
    ...
    private static final String SELECT_ALL = "SELECT * FROM music.user_profile";
    private static final String SELECT_ONE = "SELECT * FROM music.user_profile WHERE id=?";
    private static final String CREATE = "INSERT music.user_profile (user_name, surname) VALUES (?,?)";
    private static final String UPDATE = "UPDATE music.user_profile SET user_name=?, surname=? WHERE id=?";
    private static final String DELETE = "DELETE FROM music.user_profile WHERE id=?";
